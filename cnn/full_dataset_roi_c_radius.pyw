...
path1 = 'C:\\Users\\mmedek.MMEDEK-NB\\Documents\\Python Scripts\\data_roi_c_radius'    #path of folder of images    
...
y_test = np.empty((20, 1), dtype=int)
a = 10
for i in range(a):
    y_test[i] = 1
...
y_train = np.empty((130, 1), dtype=int)
a = 65
for i in range(a):
    y_train[i] = 1 
    
for i in range(a,130):
    y_train[i] = 0 
